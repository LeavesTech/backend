...
@SQLDelete(sql = "UPDATE department SET deleted = true , deleted_at = now() WHERE id = ?")
@SQLRestriction("deleted = false")
public class Department extends AbstractSoftDeleteAuditingEntity implements Serializable {
