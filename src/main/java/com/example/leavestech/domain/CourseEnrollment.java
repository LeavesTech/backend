...
@SQLDelete(sql = "UPDATE course_enrollment SET deleted = true , deleted_at = now() WHERE id = ?")
@SQLRestriction("deleted = false")
public class CourseEnrollment extends AbstractSoftDeleteAuditingEntity implements Serializable {
