...
@SQLDelete(sql = "UPDATE coding_question SET deleted = true , deleted_at = now() WHERE id = ?")
@SQLRestriction("deleted = false")
public class CodingQuestion extends AbstractSoftDeleteAuditingEntity implements Serializable {
