...
/**
 * REST controller for managing {@link com.example.leavestech.domain.Exam}.
 */
@RestController
...
public class ExamResource {
     ...
     */
    @GetMapping("")
    public List<ExamDTO> getAllExams(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
