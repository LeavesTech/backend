...
import { sampleWithRequiredData } from '../course-enrollment.test-samples';
...
describe('CourseEnrollment Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.courseEnrollments()[0]).toEqual(expect.objectContaining({ id: 11487 }));
  });

  describe('trackId', () => {
    it('should forward to courseEnrollmentService', () => {
      const entity = { id: 11487 };
      jest.spyOn(service, 'getCourseEnrollmentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCourseEnrollmentIdentifier).toHaveBeenCalledWith(entity);
