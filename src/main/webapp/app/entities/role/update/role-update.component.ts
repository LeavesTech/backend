...
export class RoleUpdateComponent implements OnInit {
  ...
  authUsersSharedCollection: IAuthUser[] = [];
  ...
  protected updateForm(role: IRole): void {
    ...
    this.authUsersSharedCollection = this.authUserService.addAuthUserToCollectionIfMissing<IAuthUser>(
      this.authUsersSharedCollection,
      ...(role.users ?? []),
    );
  }
  ...
  protected loadRelationshipsOptions(): void {
    ...
    this.authUserService
      ...
      .pipe(
        map((authUsers: IAuthUser[]) =>
          this.authUserService.addAuthUserToCollectionIfMissing<IAuthUser>(authUsers, ...(this.role?.users ?? [])),
        ),
      )
      .subscribe((authUsers: IAuthUser[]) => (this.authUsersSharedCollection = authUsers));
  }
}
