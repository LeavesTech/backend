...
import static com.example.leavestech.domain.StudentAsserts.*;
...
class StudentResourceIT {
    ...
    public static Student createEntity() {
        return new Student().studentNumber(DEFAULT_STUDENT_NUMBER);
    }
    ...
    public static Student createUpdatedEntity() {
        return new Student().studentNumber(UPDATED_STUDENT_NUMBER);
    }
    ...
    @Test
    @Transactional
    void checkStudentNumberIsRequired() throws Exception {
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.studentNumber(UPDATED_STUDENT_NUMBER);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.studentNumber(UPDATED_STUDENT_NUMBER);
